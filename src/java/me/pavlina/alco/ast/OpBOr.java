 ...
 * Bitwise OR operator.
 */
public class OpBOr extends Expression.Operator {
    Token token;
    Method method;
    Expression[] children;
    Type type;
    ...
    public OpBOr (Env env, TokenStream stream, Method method) throws CError {
        token = stream.next ();
    ...
    public int getPrecedence () {
        return me.pavlina.alco.language.Precedence.BIT_OR;
    }
    ...
    public void genLLVM (Env env, LLVMEmitter emitter, Function function)
    {
        ...
        if (bitor != null) {
            ...
            bitor.lhs (coerce.getValueStringL ());
            bitor.rhs (coerce.getValueStringR ());
    ...
    static {
        CREATOR = new Expression.OperatorCreator () {
                public Operator create (Env env, TokenStream stream,
                    ...
                    return new OpBOr (env, stream, method);
                }
            };
    }
}
