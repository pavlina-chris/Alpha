...
public class OpAssignRem extends Expression.Operator {
    Token token;
    Method method;
    Type type;
    Expression[] children;
    ...
    public void genLLVM (Env env, LLVMEmitter emitter, Function function) {
        ...
        if (remnum != null) {
            ...
            remnum.lhs (children[0].getValueString ());
            remnum.rhs (cast.getValueString ());
            remnum.genLLVM (env, emitter, function);
            valueString = remnum.getValueString ();
    ...
    static {
        CREATOR = new Expression.OperatorCreator () {
                public Operator create (Env env, TokenStream stream,
                    ...
                    return new OpAssignRem (env, stream, method);
                }
            };
    }
}
