 ...
 */
public class OpBXor extends Expression.Operator {
    Token token;
    Method method;
    Expression[] children;
    Type type;
    ...
    public int getPrecedence () {
        return me.pavlina.alco.language.Precedence.BIT_XOR;
    }
    ...
    private void checkTypes_ (Env env, Resolver resolver) throws CError {
        ...
        type = coerce.getType ();
        bitxor = new BitXor (token)
            .type (type);
        bitxor.checkTypes (env, resolver);
    }
    ...
    public void genLLVM (Env env, LLVMEmitter emitter, Function function)
    {
        ...
        if (bitxor != null) {
            ...
            bitxor.lhs (coerce.getValueStringL ());
            bitxor.rhs (coerce.getValueStringR ());
            bitxor.genLLVM (env, emitter, function);
            valueString = bitxor.getValueString ();
    ...
    static {
        CREATOR = new Expression.OperatorCreator () {
                public Operator create (Env env, TokenStream stream,
                    ...
                    return new OpBXor (env, stream, method);
                }
            };
    }
}
